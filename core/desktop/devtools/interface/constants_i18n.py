...
LANG_PACK = {
    "en": {
        ...
        "ERR_STATUS_REQUIRED": "Provide status: TODO | ACTIVE | DONE (aliases OK | WARN | FAIL)",
        ...
        "CTA_KEYS_HINT": "Keys: Enter — open • q — exit • r — refresh",
        ...
        "HELP_EXAMPLE_DOMAIN": "Example: apply_task create \"Ship feature\" --parent TASK-001 --description \"...\" --tests \"pytest -q\" --risks \"perf;deps\" --subtasks @subtasks.json --domain lab/backend",
    ...
    "ru": {
        ...
        "ERR_STATUS_REQUIRED": "Укажи статус: TODO | ACTIVE | DONE (алиасы OK | WARN | FAIL)",
        ...
        "CTA_KEYS_HINT": "Клавиши: Enter — открыть • q — выход • r — обновить",
        ...
        "HELP_EXAMPLE_DOMAIN": "Пример: apply_task create \"Ship feature\" --parent TASK-001 --description \"...\" --tests \"pytest -q\" --risks \"perf;deps\" --subtasks @subtasks.json --domain lab/backend",
